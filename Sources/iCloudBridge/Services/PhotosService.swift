...
class PhotosService: ObservableObject {
    ...
    private func isAutoGeneratedAlbum(_ title: String?) -> Bool {
        ...
        // Common patterns from iPhoto imports and auto-generated albums
        let autoGeneratedPatterns = [
            ...
            // Just a year "2015"
            "^\\d{4}$",
            // "Roll 82" - old iPhoto rolls
            "^Roll \\d+$",
            // "Jan 2013 Photo Stream" or similar Photo Stream imports
            "Photo Stream$",
            // "Last Import" or other import-related
            "^Last Import",
            // Untitled albums
            "^Untitled",
            // Photo Booth
        ...
        for pattern in autoGeneratedPatterns {
