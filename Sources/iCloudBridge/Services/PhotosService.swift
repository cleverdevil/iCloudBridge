...
class PhotosService: ObservableObject {
    ...
    private func isAutoGeneratedTitle(_ title: String?) -> Bool {
        ...
        let excludeContains = ["Photo Stream", "Photo Booth", "Last Import"]
        for pattern in excludeContains {
        ...
        // Prefix checks
        let excludePrefixes = ["Roll ", "Untitled"]
        ...
        // Check for date patterns: "Mon DD, YYYY" with optional " (N)" suffix
        // Examples: "Dec 3, 2010", "Jan 20, 2012", "May 13, 2012 (1)"
    ...
    func loadAlbums() {
        ...
        // Fetch user albums (subtype .albumRegular only)
        ...
        allUserAlbums.enumerateObjects { collection, _, _ in
            // Filter out auto-generated titles (iPhoto imports, Photo Stream, etc.)
            if !self.isAutoGeneratedTitle(collection.localizedTitle) {
